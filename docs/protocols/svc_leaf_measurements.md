...
experiment. Some steps are very specific in file naming and
measurements. If you need a more specific protocol tailored to your
project, create another protocol while using this as a template and
store in protocols with your project in “Associated Project”. The SVC
settings are the same throughout projects.
