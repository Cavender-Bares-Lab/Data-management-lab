---
title: "Surface Sterilization Protocol"
date: "`r Sys.Date()`"
output: md_document
author: "May Lab"
...
This protocol is for the surface sterilization of leaves for fungal endophytes analyses using ethanol and bleach.
...
* Forceps.
* This should be performed in a BSL1 or BSL2/laminar flow hood to keep the
leaves in a sterile environment.
...
- Any plant samples that are not used should be bagged and stored in freezer for 
further use or autoclaved and disposed of in the garbage.
