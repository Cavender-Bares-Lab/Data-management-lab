...
#### Fulcrum App
Fulcrum App is a data collection platform designed to access via mobile phone ideal for field work. Create and design apps through the [webpage](www.fulcrumapp.com).
