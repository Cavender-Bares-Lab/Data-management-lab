...
Created, remove, and update documentation is essential for any project project. 
This webpage was created using [Mkdocs](https://www.mkdocs.org/) to satisfy the 
documentation requirements for the lab. 

This webpage does not not replaceable data storage requirements (e.g., group/cavender, 
google drive, or local drives), but it allows users to respond questions like: 
