...
All the data is currently storage at the tier-1 of [Minnesota Supercomputing Institute](https://www.msi.umn.edu/) under `gruops/cavender/guzman/oak-wilt`.

## Folder structrue

Under `gruops/cavender/guzman/oak-wilt` the folders follow the structure:
