...
3. Set scale
    ...
    b. Write 
        i.    Distance in pixels: 236 
        ii.   Known distance: 1
        iii.  Pixel aspect ratio: 1.0
        iv.   Unit of length: cm
        v.    Click "Global".
        vi.   OK

3. Use the rectangle button and choose a square. 
    a. Use ctrl+shift to create a square.
    b. The selection size appears in the status bar. Always keep at exactly 236 pixels/1 cm per side.
...
1. Go to the ROI Manager 
  ...
  c. Paste the values in an excel file to calculate the length sum. 
